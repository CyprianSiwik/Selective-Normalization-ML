...
def run_norm(model_type='cnn', dataset='cifar10', normalization='batch'):
    """
    ...
    if model_type == 'cnn':
        ...
        model = MLP(input_size=input_size, hidden_sizes=[512, 256], num_classes=num_classes, dropout=0.0, norm=normalization)
